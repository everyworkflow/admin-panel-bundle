...
import SearchSidePanel from "@EveryWorkflow/AdminPanelBundle/Admin/Component/LeftMostSidebarComponent/SearchSidePanel";
import NotificationSidePanel
    from "@EveryWorkflow/AdminPanelBundle/Admin/Component/LeftMostSidebarComponent/NotificationSidePanel";
import MessageSidePanel
    from "@EveryWorkflow/AdminPanelBundle/Admin/Component/LeftMostSidebarComponent/MessageSidePanel";
import AccountSidePanel
    from "@EveryWorkflow/AdminPanelBundle/Admin/Component/LeftMostSidebarComponent/AccountSidePanel";
import SettingSidePanel
    from "@EveryWorkflow/AdminPanelBundle/Admin/Component/LeftMostSidebarComponent/SettingSidePanel";
    ...
    return (
        <>
                ...
                <div style={{borderBottom: 'solid 1px #ffffff'}}>
                    ...
                    <div style={{paddingLeft: 8, paddingRight: 8, marginBottom: 16}}>
                        <Tooltip title="Notification" placement="right">
                            <Badge count={panelState.alert_data.length}>
                                <Button
                                    shape="circle"
                                    icon={<BellOutlined/>}
                                    onClick={() => {
            ...
            {sidePanelState === 'search' && (
                <SearchSidePanel onSidePanelClose={onSidePanelClose} panelState={panelState}/>
            )}
            {sidePanelState === 'notification' && (
                <NotificationSidePanel onSidePanelClose={onSidePanelClose} panelState={panelState}/>
            )}
            {sidePanelState === 'message' && (
                <MessageSidePanel onSidePanelClose={onSidePanelClose} panelState={panelState}/>
            )}
            {sidePanelState === 'account' && (
                <AccountSidePanel onSidePanelClose={onSidePanelClose} panelState={panelState}/>
            )}
            {sidePanelState === 'panel-control' && (
                <SettingSidePanel onSidePanelClose={onSidePanelClose} panelState={panelState}/>
            )}
        </>
    );
}
